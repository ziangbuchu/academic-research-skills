...
**简体中文**: 研究, 深度研究, 文献回顾, 文献探讨, 系统性回顾, 后设分析, 证據综整, 事实查核, 研究方法, 学术分析, 政策分析, 引导我的研究, 帮我厘清, 监测这个主题, 设定追踪
...
"guide my research", "help me think through", 「引导我的研究」「帮我厘清」, or equivalent in any language
...
|----------------|-----------------|
| Vague idea, need guidance / 有模糊想法，需要引导 | `socratic` |
| Clear RQ, need comprehensive research / 有明确 RQ，需要完整研究 | `full` |
| Need a quick brief (30 min) / 需要快速摘要 | `quick` |
| Have a paper to evaluate before citing / 有论文需要評估 | `review` |
| Need literature review for a topic / 需要文献回顾 | `lit-review` |
| Need to verify specific claims / 需要查核特定事实 | `fact-check` |
| Need systematic review / meta-analysis / 系统性回顾或后设分析 | `systematic-review` |

Not sure? Start with `socratic` — it will help you figure out what you need.
不确定？先用 `socratic` 模式——它会帮你厘清你需要什么。
